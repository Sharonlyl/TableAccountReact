...
const URL_CONS = {
    ...
    QUERY_LMR_REFERENCE_BY_CATEGORY_URL: '/api/groupCompany/queryImrReferenceByCategory',
    ...
    UPDATE_GROUP_COMPANY_MAPPING_URL: '/api/groupCompany/addGroupCompanyMapping'
}
